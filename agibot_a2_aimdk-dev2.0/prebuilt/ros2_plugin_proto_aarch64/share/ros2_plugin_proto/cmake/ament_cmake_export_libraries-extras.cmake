...
set(_exported_libraries
    "ros2_plugin_proto__rosidl_generator_c;ros2_plugin_proto__rosidl_typesupport_c;ros2_plugin_proto__rosidl_typesupport_cpp"
)
  ...
  while(_i LESS _length)
    ...
    if("${_arg}" MATCHES "^(debug|optimized|general)$")
      ...
      if(_i EQUAL _length)
        message(
          FATAL_ERROR
            "Package 'ros2_plugin_proto' passes the build configuration keyword '${_cfg}' as the last exported library")
      endif()
    ...
    if(NOT IS_ABSOLUTE "${_library}")
      ...
      elseif(NOT IS_ABSOLUTE "${_lib}")
        ...
        message(
          FATAL_ERROR
            "Package 'ros2_plugin_proto' found the library '${_library}' at '${_lib}' which is not an absolute path")
  ...
  while(_i LESS _length)
    ...
    if("${_arg}" MATCHES "^(debug|optimized|general)$")
      ...
      if(_i EQUAL _length)
        message(
          FATAL_ERROR
            "Package 'ros2_plugin_proto' passes the build configuration keyword '${_cfg}' as the last exported target")
      endif()
    ...
    if(NOT _library_dirs)
      ...
      find_library(_lib NAMES "${_library_name}")
      if(NOT _lib)
